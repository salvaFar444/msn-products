...
const securityHeaders = [
  ...
  },
  {
    ...
    value: [
      "default-src 'self'",
      "img-src 'self' https://*.supabase.co https://cdn.shopify.com https://*.shopify.com https://wa.me data: blob:",
      "script-src 'self' 'unsafe-inline' 'unsafe-eval'",
      "style-src 'self' 'unsafe-inline' https://fonts.googleapis.com",
      "font-src 'self' https://fonts.gstatic.com data:",
      "connect-src 'self' https://*.supabase.co https://*.myshopify.com https://cdn.shopify.com",
      "frame-ancestors 'none'",
      "base-uri 'self'",
      "form-action 'self' https://wa.me https://*.myshopify.com https://*.shopify.com",
    ].join('; '),
  },
]
